...
func run() error {
	...
	srv := &httpserver.Server{
		...
		EditSession:        usecase.EditSession{Sessions: sessionStore, Nodes: nodeStore, Tags: tagStore},
		DeleteSession:      usecase.DeleteSession{Sessions: sessionStore, Tags: tagStore},
		AddSession:         usecase.AddSession{Sessions: sessionStore, Nodes: nodeStore, IDs: ids, Clock: clock, Tags: tagStore},
		...
		CreateDocument:        usecase.CreateDocument{Docs: documentStore, Nodes: nodeStore, IDs: ids, Clock: clock, Notifier: embedWorker, Tags: tagStore},
		ImportDocument:        usecase.ImportDocument{Docs: documentStore, Nodes: nodeStore, IDs: ids, Clock: clock, Notifier: embedWorker, Tags: tagStore},
		...
		UpsertDocumentByPath:  usecase.UpsertDocumentByPath{Docs: documentStore, Nodes: nodeStore, Tags: tagStore, Notifier: embedWorker},
