...
func TestCheckShrink(t *testing.T) {
	...
	passes := []struct {
		...
		// Ratio unter 50 % — darf nicht anschlagen, auch wenn Bytes entfernt wurden.
		{"well below both thresholds", bodyDelta{BytesBefore: 4096, BytesAfter: 3072, LinesBefore: 100, LinesAfter: 75}},
