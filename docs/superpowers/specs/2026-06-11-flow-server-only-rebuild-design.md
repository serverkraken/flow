...
- **Statuszeile überall** (Worktime-Spine + Standalone-Subcommands): `● msoent @ flow.thebackend.org` · offline: `○ offline · Stand 14:32 (read-only)` · ohne Login: `○ nicht angemeldet · flow login` · veraltet: `⚠ Client veraltet`.
