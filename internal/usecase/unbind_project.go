...
// UnbindProject removes a project binding by kind-key.
type UnbindProject struct {
	Bindings ports.ProjectBindingStore
}

func (uc UnbindProject) Execute(ctx context.Context, ownerID string, k BindKey) error {
	switch k.Kind {
