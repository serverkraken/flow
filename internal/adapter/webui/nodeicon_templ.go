...
func NodeIcon(key, class string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if svg := NodeIconSVG(key); svg != "" {
			var templ_7745c5c3_Var2 = []any{"inline-grid shrink-0 place-items-center", class}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/webui/nodeicon.templ`, Line: 1, Col: 0}
			}
