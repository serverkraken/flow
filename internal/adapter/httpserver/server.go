...
func (s *Server) Routes() http.Handler {
	...
	mux.Handle("GET /nodes/{id}/wissen", s.webAuth(http.HandlerFunc(s.handleWebNodeWissen)))
	mux.Handle("GET /nodes/{id}/kasten", s.webAuth(http.HandlerFunc(s.handleWebNodeKasten)))
