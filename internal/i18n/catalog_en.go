...
func init() {
	register(EN, catalog{
		strings: map[string]string{
			...
			"cockpit.rail.rate":            "Hourly rate",
			"cockpit.rail.todayHere":       "today here",
			"cockpit.rail.countsWork":      "counts as Work",
			"cockpit.rail.countsPrivat":    "Private — tracked only",
			"cockpit.rail.inherited":       "inherited from",
			"cockpit.rail.contributors":    "Contributors",
			"cockpit.rail.children":        "Subnodes",
